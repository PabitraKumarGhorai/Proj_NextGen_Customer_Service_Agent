...
# MAGIC
# MAGIC SYSTEM_PROMPT = """
# MAGIC Summarize my output clearly
# MAGIC Format responses in bold
# MAGIC Use tables whenever possible
# MAGIC Always give most preferable answer at top
# MAGIC """
# MAGIC
# MAGIC
# MAGIC ###############################################################################
...
# MAGIC UC_TOOL_NAMES = ["agentic_catalog.agentic_schema.get_service_history", "agentic_catalog.agentic_schema.get_types_of_policies", "agentic_catalog.agentic_schema.get_return_policy"]
# MAGIC
...
# MAGIC             index_name="agentic_catalog.agentic_schema.proj_customer_service_ai_search_index",
...
model_name = "customer_service_agent"
