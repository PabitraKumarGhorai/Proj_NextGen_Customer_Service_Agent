...
SYSTEM_PROMPT = """
Summarize my output clearly
Format responses in bold
Use tables whenever possible
Always give most preferable answer at top
"""
...
UC_TOOL_NAMES = ["agentic_catalog.agentic_schema.get_service_history", "agentic_catalog.agentic_schema.get_types_of_policies", "agentic_catalog.agentic_schema.get_return_policy"]
...
VECTOR_SEARCH_TOOLS.append(
        VectorSearchRetrieverTool(
            index_name="agentic_catalog.agentic_schema.proj_customer_service_ai_search_index",
